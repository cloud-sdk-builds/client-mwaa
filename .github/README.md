...
[`@aws-sdk/client-mwaa`](https://www.npmjs.com/package/@aws-sdk/client-mwaa/v/3.774.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa@3.774.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xdY/3ihnNId+FmHliEquiom4UGdYIfap3BsdQcG8BiF0cBy5IBtdt3b55h0rDQrw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa@3.774.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa@3.774.0/index.min.mjs": "sha384-xdY/3ihnNId+FmHliEquiom4UGdYIfap3BsdQcG8BiF0cBy5IBtdt3b55h0rDQrw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa/blob/refs/tags/3.774.0/LICENSE
```
