...
[`@aws-sdk/client-mwaa`](https://www.npmjs.com/package/@aws-sdk/client-mwaa/v/3.405.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa@3.405.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-d1DjGNhmay0svIVpSaD19nbbYodrbVo0blEPGxr5v7+QDRwGVtBdufygVH4L//fz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mwaa": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa@3.405.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mwaa@3.405.0/index.min.mjs": "sha384-d1DjGNhmay0svIVpSaD19nbbYodrbVo0blEPGxr5v7+QDRwGVtBdufygVH4L//fz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mwaa/blob/refs/tags/3.405.0/LICENSE
```
